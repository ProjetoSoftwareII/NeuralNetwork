...
#
  ...
  #loss de     de acerto 'lt: 87.30312 lv: 30.92616 epoch:45.h5' T 1.29
  model = tf.keras.models.load_model('/usr/app/src/dataset/treino/lt: 120.85935 lv: 41.15373 epoch:40.h5')
